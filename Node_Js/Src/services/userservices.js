...
const updateDoctor = async (id, body) => {
  ...
  const data = await DoctorModel.findByIdAndUpdate({ _id: id }, body, {
    new: true,
  });
  return data;
};
...
const updateNurse = async (id, body) => {
  ...
  const data = await NurseModel.findByIdAndUpdate({ _id: id }, body, {
    new: true,
  });
  return data;
};
...
const updatePatient = async (id, body) => {
  ...
  const data = await PatientModel.findByIdAndUpdate({ _id: id }, body, {
    new: true,
  });
  return data;
};
